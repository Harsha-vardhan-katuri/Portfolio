...
import NeonArcAnimation from "./animations/NeonArcAnimation"
import HolographicGlobeAnimation from "./animations/HolographicGlobeAnimation"
import SolarEclipseAnimation from "./animations/SolarEclipseAnimation"
import PlanetAtmosphereAnimation from "./animations/PlanetAtmosphereAnimation"
              ...
              `}</style>
                ...
                >
                  <p className="text-white text-lg leading-relaxed mb-6 font-semibold">
                    I am a dedicated <span className="font-black text-red-700">Firmware Engineer</span> currently
                    working at HealthCube Private Limited, specializing in embedded systems and IoT solutions. My
                    expertise lies in developing robust firmware for microcontrollers, particularly{" "}
                    <span className="text-cyan-500 font-black">ESP32</span>, and implementing various communication
                    protocols including{" "}
                    <span className="font-black text-purple-800">LoRa, RS485, UART, I2C, and SPI</span>.
                  </p>
                  <p className="text-white text-lg leading-relaxed font-semibold">
                    With hands-on experience in{" "}
                    <span className="font-black text-yellow-300">agricultural IoT systems</span> and{" "}
                    <span className="text-purple-500 font-black">medical device firmware</span>, I focus on creating
                    efficient, low-power solutions that deliver reliable performance in real-world applications. My
                    recent work includes developing a{" "}
                    <span className="font-black text-red-600">LoRa-enabled soil health</span> monitoring system and
                    contributing to production-grade medical device firmware.
                  </p>
                </motion.div>
              </div>
            </div>
      ...
      default:
        return (
          <div className="flex flex-col items-center text-center space-y-8 max-w-2xl mx-auto min-h-screen justify-center">
            ...
            .action-button:hover .wave-text {
              animation: wave-letter 0.8s ease-in-out 1;
            }

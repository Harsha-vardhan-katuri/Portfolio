...
export const Navigation = () => {
  ...
  return (
    <>
      ...
      <nav className={`hidden md:block fixed top-0 left-0 right-0 z-50 transition-colors duration-500 ${scrolled ? 'bg-background/85 border-b border-foreground/5' : ''}`}>
      ...
      {/* Mobile Navigation */}
      <nav className="md:hidden fixed top-0 left-0 right-0 z-50 bg-background/90 border-b border-foreground/5">
